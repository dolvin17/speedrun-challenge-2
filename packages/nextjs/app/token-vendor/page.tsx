  ...
  return (
    <>
      <div className="flex flex-col items-center flex-grow pt-10">
        <div className="flex flex-col items-center w-full max-w-lg p-6 mt-24 border-8 shadow-lg bg-base-100 shadow-secondary border-secondary rounded-xl">
          <div className="text-xl">
            Your token balance:{" "}
            <div className="inline-flex items-center justify-center">
              {parseFloat(formatEther(yourTokenBalance || 0n)).toFixed(4)}
              <span className="ml-1 font-bold">{yourTokenSymbol}</span>
            </div>
          </div>
           Vendor Balances  
           <hr className="w-full my-3 border-secondary" />
          <div>
          ...
          Buy Tokens  
          <div className="flex flex-col items-center w-full max-w-lg p-6 mt-8 space-y-4 border-8 shadow-lg bg-base-100 shadow-secondary border-secondary rounded-xl">
